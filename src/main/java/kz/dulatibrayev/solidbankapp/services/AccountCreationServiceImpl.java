...
public class AccountCreationServiceImpl implements AccountCreationService {
	...
	@Override
	public void create(AccountType accountType, String id, String clientID, long accountID) {

		switch (accountType) {
		case CHECKING:
			accountDAO.createNewAccount(new CheckingAccount(accountType, String.valueOf(accountID), clientID, 0.0, true));
			break;
		case SAVING:
